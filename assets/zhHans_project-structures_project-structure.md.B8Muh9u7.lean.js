import{_ as n,c as a,a2 as p,o as e}from"./chunks/framework.BQmytedh.js";const g=JSON.parse('{"title":"项目结构","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"zhHans/project-structures/project-structure.md","filePath":"zhHans/project-structures/project-structure.md","lastUpdated":1745673368000}'),l={name:"zhHans/project-structures/project-structure.md"};function i(t,s,c,r,o,u){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="项目结构" tabindex="-1">项目结构 <a class="header-anchor" href="#项目结构" aria-label="Permalink to &quot;项目结构&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>└─ README.md - 仅在GitHub上使用的文件</span></span></code></pre></div>`,2)]))}const m=n(l,[["render",i]]);export{g as __pageData,m as default};
